...
import { Terminal, Leaf, ShieldAlert, History, Globe, MessageSquare } from 'lucide-react';
...
const UserSidebar = ({ 
  ...
  return (
    <div className="side-panel expanded">
      ...
      <div className="widget" style={{ pointerEvents: 'auto', padding: '0.75rem 1.25rem', display: 'flex', alignItems: 'center', gap: '0.75rem', background: 'rgba(255,255,255,0.95)', borderBottom: '1px solid var(--glass-border)' }}>
      ...
      <div className="widget content-widget" style={{ pointerEvents: 'auto', flex: 1, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
            ...
            <div className="panel-section">
              ...
              <div style={{ marginTop: '1rem', padding: '1.25rem', background: 'rgba(37,99,235,0.02)', borderRadius: '12px', border: '1px solid var(--accent-glass)' }}>
                <div style={{ marginBottom: '0.75rem' }}>
                  ...
                  <select id="complaint-dept" style={{ width: '100%', padding: '0.75rem', borderRadius: '10px', border: '2px solid var(--glass-border)', fontSize: '0.8rem', background: '#f8fafc', color: '#1e293b', outline: 'none', cursor: 'pointer', pointerEvents: 'auto', position: 'relative', zIndex: 100 }}>
                ...
                <div style={{ marginBottom: '1rem' }}>
                  <label style={{ fontSize: '0.55rem', fontWeight: 900, color: 'var(--text-secondary)', display: 'block', marginBottom: '0.4rem' }}>DESCRIPTION</label>
                  <textarea id="complaint-desc" placeholder="Describe the issue..." style={{ width: '100%', minHeight: '100px', padding: '0.75rem', borderRadius: '10px', border: '2px solid var(--glass-border)', fontSize: '0.8rem', background: '#f8fafc', color: '#1e293b', outline: 'none', resize: 'none', pointerEvents: 'auto', position: 'relative', zIndex: 100 }} />
                </div>
                ...
                }} style={{ background: 'var(--accent)', marginTop: '0.5rem', pointerEvents: 'auto', position: 'relative', zIndex: 100 }}>SUBMIT COMPLAINT</button>
              </div>
            </div>
          )}
        </div>
